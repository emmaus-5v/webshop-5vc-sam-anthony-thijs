...
insert into products (name, description, code, price, diersoort, kleur, ras, geslacht, gewicht) values ('Konijn', 'Heeft u altijd al een schattig knaagdier gewild dan is dit uw kans voor een schattig klein dwergse langhoor.', '445924201-X', 15.60, 2, 'bruin', 'Nederlandse Hangoor Dwerg', 2, 5);
...
insert into products (name, description, code, price, diersoort, kleur, ras, geslacht, gewicht) values ('Capybara', 'Heeft u altijd al een grote cavia gewild of dan is dit uw kans om een capybara te verkrijgen (wij hebben alle vernodigde vergunningen om hem veilig en wel naar uw te verkopen).', '2353465564-2', 696.96, 6, 'Bruin', 'nvt', 1, 40);
