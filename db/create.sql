...
insert into products (name, description, code, price, diersoort, kleur, ras, geslacht, gewicht) values ('Goudvis', 'Hier kan je uiteraard ook een goudvis kopen! Mocht het voor je kind zijn of voor jezelf, voor ieder is het geschikt.', '686928463-6', 4.50, 4, 'Oranje', 'Goudvis', 3, 0.1);
insert into products (name, description, code, price, diersoort, kleur, ras, geslacht, gewicht) values ('Grasparkiet', 'Bent u een vogelliefhebber, maar weet je niet waar je aan moet beginnen? Wij verkopen hier de grasparkiet!', '492662523-7', 26.45, 5, 'Citroengeel', 'Grasparkiet', 1, 0.4);
...
insert into products (name, description, code, price, diersoort, kleur, ras, geslacht, gewicht) values ('Sprinkhaan', 'Toch meer een insecten liefhebber? Of heb je hem nodig als voedsel voor je dieren? Voor beide redenen hier te koop.', '2352427564-2', 1.50, 7, 'Groen', 'nvt', 2, 0.07);
insert into products (name, description, code, price, diersoort, kleur, ras, geslacht, gewicht) values ('Kat', 'Heeft u altijd al een schattige, mogelijk, chagrijnige kat gewild? Grijp dan nu uw kans! *150 euro zonder vaccinaties en 350 euro met vacinaties.*', '2352465564-2', 150.00, 8, 'Grijs', 'Britse Langhaar', 2, 10);
...
insert into products (name, description, code, price, diersoort, kleur, ras, geslacht, gewicht) values ('German Shepherd','Wilt u een hond, maar weet u niet waar u aan moet beginnen? Een leuke bruine German Shepherd is een goeie keus als eerste hond! *199 euro voor een German Shepherd zonder vaccinaties, mocht je het bij een dierenarts willen. 600 euro met vacinaties als je het bij ons meteen wilt.*', '693158505-7', 199.00, 3, 'bruin', 'German Shepherd', 2, 27);
insert into products (name, description, code, price, diersoort, kleur, ras, geslacht, gewicht) values ('Picasso doktersvis', 'Hier kan je uiteraard ook een Picasso doktersvis kopen! Mocht het voor je kind zijn of voor jezelf, voor ieder is het geschikt.', '686978463-6', 4.50, 4, 'blauw', 'Picasso doktersvis', 3, 0.1);
insert into products (name, description, code, price, diersoort, kleur, ras, geslacht, gewicht) values ('Dwergpapegaai', 'Bent u een vogelliefhebber, maar weet je niet waar je aan moet beginnen? Wij verkopen hier de Dwergpapegaai, dit vrolijke beest zal een goede toevoeging zijn aan uw huishouden!', '492662523-7', 26.45, 5, 'rood-groen', 'Dwergpapegaai', 1, 0.4);
...
insert into diersoorten (ds_naam) values ('vis');
insert into diersoorten (ds_naam) values ('vogel');
