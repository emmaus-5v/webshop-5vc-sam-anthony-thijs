...
insert into products (name, description, code, price, diersoort, kleur, ras, geslacht, gewicht) values ('Kat', 'Heeft u altijd al een schattige, mogelijk, chagerijninge kat gewild? Grijp dan nu uw kans! *150 euro zonder vaccinaties en 350 euro met vacinaties.*', '2352465564-2', 150.00, 8, 'Grijs', 'Britse Langhaar', 2, 10);
...
insert into products (name, description, code, price, diersoort, kleur, ras, geslacht, gewicht) values ('Dwergpapegaai', 'Bent u een vogelliefhebber, maar weet je niet waar je aan moet beginnen? Wij verkopen hier de Dwergpapegaai, dit vrolijke beest zal uw huishouden meteen verlichten!', '492662523-7', 26.45, 5, 'rood-groen', 'Dwergpapegaai', 1, 0.4);
